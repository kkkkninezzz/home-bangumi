...
import { manualParseEpisode, ManualParseEpisodeReq } from "@/api/rssBangumi";
import { message } from "@/utils/message";

defineOptions({
  name: "RssBangumiEpisodeManualParseDialogForm"
});
...
const handleManaulParse = async (
  ...
  const req: ManualParseEpisodeReq = {
  ...
  const resp: ApiResult = await manualParseEpisode(
    props.rssBangumiId,
    props.episodeId,
    req
  );
